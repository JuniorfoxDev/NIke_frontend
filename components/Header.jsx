...
const Header = () => {
  ...
  return (
    <header className={`w-full h-[50px] md:h-[80px] bg-slate-50 flex items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show} `}>
      <Wrapper className="h-[50px] flex justify-between items-center">
        ...
        <div className='flex items-center gap-2 text-black'>
                ...
                <div className='w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative'>
                    ...
                    {/* <div className='h-[14px] md:h-[20px] min-w-[14px] md:min-w-[20px] rounded-full bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[15px] flex justify-center items-center px-[2px] md:px-[5px]'>5</div> */}
                </div>
                </Link>
                <div className='w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-black/[0.05] cursor-pointer relative'>
                    <IoMdHeartEmpty className='text-[15px] md:text-[20px]' />
                    <div className='h-[14px] md:h-[20px] min-w-[14px] md:min-w-[20px] rounded-full bg-red-600 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[15px] flex justify-center items-center px-[2px] md:px-[5px]'>52</div>
                </div>
