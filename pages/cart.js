    ...
    <div className='w-full md:py-20'>
        <Wrapper>
            ...
            <div className='text-[28px] md:text-[34px] mb-5 font-semibold leading-tight'>
                ...
                <div className='flex flex-col lg:flex-row gap-12 py-10'>
                    <div className='flex-[2]'>
                            <div className='text-[20px] mb-2  font-semibold'>Cart Items</div>
                   {cartItems.map((item) => (
                    <CartItem key={item.id} data={item}/>
                   ))}
                    </div>
                <div className='flex-[1]'>
                <div className='text-[20px] mb-2 font-semibold'>Summary</div>
            ...
            <div className='flex-[2] flex flex-col items-center pb-[50px] md:-mt-14'>
                ...
                <Link href="/" className='py-4 px-8 rounded-full bg-black text-white text-lg font-medium transition-transform active:scale-75 mb-3 hover:opacity-70 mt-8' > Continue Shopping</Link>
            </div>
            )}
        </Wrapper>
    </div>
